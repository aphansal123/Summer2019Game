...
public class TeddyBearSpawner : MonoBehaviour {
    // needed for spawning
    [SerializeField] // this makes fields visible in the inspector
    ...
    // info to spawn in the appropriate location
    int minSpawnX;
    int maxSpawnX;
    int minSpawnY;
    int maxSpawnY;
    ...
    void SpawnBear() {
        ...
        // determine which sprite to select based on random number
        if (spriteNumber == 0)
        {
